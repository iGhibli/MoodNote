...
- (UIView *)clearView {
    if (_clearView == nil) {
        ...
        UILabel *memory = [[UILabel alloc]initWithFrame:CGRectMake(10, kScreenH / 2 - 35, kScreenW - 20, 30)];
        memory.text = @"当前缓存: 1024 Kb";
        memory.font = [UIFont systemFontOfSize:22];
        memory.textAlignment = NSTextAlignmentCenter;
        [_clearView addSubview:memory];
        ...
        [clearBtn addTarget:self action:@selector(hiddenView) forControlEvents:UIControlEventTouchUpInside];
